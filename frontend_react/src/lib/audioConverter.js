export async function convertWebMToWav(webmBlob) {
    ...
    const numChannels = 1; // Force Mono for ESP32
    const sampleRate = 16000; // Downsample to 16kHz for ESP32 (optional but good for size/compatibility)
    
    // Resample if needed (simple linear interpolation or just let OfflineAudioContext do it)
